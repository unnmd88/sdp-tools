...
from application.interfaces.services.user_password_service_interface import UserPasswordServiceProtocol
...
class UserLoginAndIssueJWTUseCaseProtocol(Protocol):
    ...
    user_password_service: type[UserPasswordServiceProtocol]
