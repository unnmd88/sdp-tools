...
class ErrorMessages(StrEnum):
    ...
    string_too_short = "Длина строки не может быть меньше {} символов. Текущая длина: {} символов."
    string_too_long = "Длина строки не может превышать {} символов. Текущая длина: {} символов."
