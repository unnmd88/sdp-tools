from domain.exceptions.validation_exc import ContractViolationBusinessRulesError
...
from domain.users.rules_messages import BusinessRulesViolationsMessages
