# # from core.users import get_user_by_username_or_none
#
...
#
#
# async def validate_auth_user(user: AuthSchemaToValidate):
#     check_password_is_valid(user.password_plain, user.password_hashed)
